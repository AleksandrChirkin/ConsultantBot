...
public class Bot {
    ...
    public Bot(DataLoader dataLoader, StatesOfUsers statesOfUsers){
        ...
        HELP_MESSAGE = String.format("%s\nЧтобы бот мог принять ваш запрос, нужно, " +
                ...
                "компанию-производителя и другие характеристики вашего товара. Ему нужна только категория\n" +
                "3. Если бот выдал вам кнопки, но не выдал ссылки на товары, то не стоит ничего вводить с клавиатуры -" +
                " просто нажмите на нужную кнопку\n" +
                "4. Если вы хотите сделать новый запрос, нажмите на кнопку \"Сделать новый запрос\"", BOT_INTRODUCTION);
    }
